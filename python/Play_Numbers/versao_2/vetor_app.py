...
def main():
    ...
    while option != 16:
        ...
        if option == 1:
            ...
            array = vu.my_map(lambda a :corrent_value, array)
            ...
            value_min = vu.my_reduce(array,lambda a,b : a if a < b else b,array[0])
            value_max = vu.my_reduce(array,lambda a,b : a if a > b else b,array[0])
            index_value_min = array.index(value_min)
            index_value_max = array.index(value_max)
            ...
            sum = vu.my_reduce(array,lambda a,b : a + b,array[0])
            ...
            new_array = vu.my_filter(lambda a: a >= 0,array)
            count = len(new_array)
            ...
            if option_ten == 1:
                ...
                array = vu.my_map(lambda a: a * factor,array)

            elif option_ten == 2:
                exponent = int(input('Informe o valor do expoente da potenciação: '))
                array = vu.my_map(lambda a: a ** exponent ,array)

            elif option_ten == 3:
                divider = float(input('Informe o valor divisor: '))
                array = vu.my_map(lambda x : x * divider ,array)

            elif option_ten == 4:
                min_value = int(input('Informe o valor minimo da substituição:')) 
                max_value = int(input('Informe o valor maximo da substituição:')) 

                array = vu.my_map(lambda x: randint(min_value,max_value) if x < 0 else x,array)
            ...
            index = int(input('Informe o index do valor editado: '))
